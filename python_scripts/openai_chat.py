...
async def ask_model(endpoint, prompt):
    data = {"prompt": prompt}  
...
def ask_llm(prompt_text: str, user_input: str, eval_model_name: str):
    ...
    try:
        ...
        print("RESPNSE TEXT: ", response_text)
        return response_text




async def ask_llm_with_endpoint(
...
class ChatInterface:
    ...
    def create_prompt_file(self, num_words=100):
        ...
        intro_prompt = "This is a chat with Bob, an AI assistant. Use the conversation history to answer the user's question." 
    ...
    def chat(self, userInput, model_name, timeout_seconds=120):
        ...
        # response_text = await ask_model("https://llama.h2o.ai", full_prompt)
